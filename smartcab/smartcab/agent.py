...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if self.learning:
            ...
            self.alpha = .25 + math.pow(math.e, -0.05 * self.trial_num) * .5
        else:
            self.epsilon = 0
    ...
    def build_state(self):
        ...
        return None if inputs['light'] == 'red' else \
                   inputs['left'] is None, inputs['right'] is None, inputs['oncoming'] is None, waypoint
